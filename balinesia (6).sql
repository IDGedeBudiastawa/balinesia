...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2018 at 09:02 PM
...
INSERT INTO `event` (`event_id`, `evkat_id`, `user_id`, `event_nama`, `des_event`, `price_ev`, `slot_member`, `ev_place`, `ev_date`, `form`) VALUES
(2, 1, 2, 'Event2', 'Event2 Mantap', 89000, 6, 'Jalan Sayang Kamu', '2018-06-08', '10000000'),
(4, 1, 2, 'Nikah Masal', 'Dilaksanakan di tempat terbuka ', 2000000, 200, 'Yadnya Grosir', '2018-06-15', '111110000'),
(5, 1, 2, 'Event4', 'Event4 Mantap', 89000, 9, 'Kuli Indah', '2018-06-30', '11000000'),
(6, 2, 2, 'Event5', 'Event5 Keren', 89000, 9, 'Kulik Kulik', '2018-06-21', '110111000'),
(7, 1, 2, 'Menikah', 'rundown menyusul ', 2000000, 200, 'Balli', '2018-06-14', '101100110');
...
(2, 2, 'uploadupacara/06062018070720add.jpg'),
(4, 4, 'uploadupacara/06062018071138back6.jpg'),
(5, 5, 'uploadupacara/06062018071308ajuman.png'),
(6, 6, 'uploadupacara/06062018071439admin.png'),
(7, 7, 'uploadupacara/06062018101354canangsari.jpg');
...
(4, 4, 'uploadbanten/06062018070140admin.png'),
(5, 5, 'uploadbanten/06062018070218admin.png'),
(6, 6, 'uploadbanten/06062018071356admin.png');
...
INSERT INTO `order_product` (`order_id`, `id_sarana`, `user_id`, `jumlah`, `price_product`, `price_total`, `Order_status`) VALUES
(2, 4, 1, 4, 45000, 0, 1),
(3, 5, 1, 4, 89000, 0, 1),
(5, 6, 3, 3, 90000, 0, 1),
(6, 5, 3, 3, 89000, 0, 0);
...
INSERT INTO `peserta` (`peserta_id`, `event_id`, `fullname`, `panggilan`, `alamat`, `phone`, `lahir`, `usia`, `jk`, `ktp`, `email`, `status`) VALUES
(2, 2, 'Doni', '', '', '', '', '', '', '', '', 1),
(3, 4, 'Made Doni', 'Doni', 'Jalan Indah Bulu', '0812309090', '78-09-1999', '', '', '', '', 1),
(4, 5, 'Aditya', '890', '', '', '', '', '', '', '', 1),
(5, 6, 'Made Doni', 'Doni', '', '980909', '09-09-9999', '9', '', '', '', 1),
(7, 7, 'Dani ', '', 'Jimbaran ', '085444352', '', '', 'Laku-Lakai', '7677888', '', 1);
...
(4, 1, 2, 'Banten4', 'Banten4 Ganteng', 'Jalan Indah Bingit', 64, 45000, 'Ready'),
(5, 2, 2, 'Banten5', 'Banten5 Oke', 'Jalan Indah ', 64, 89000, 'Preorder'),
(6, 1, 2, 'Julik', 'Kulik', 'Jalan Indah ', 64, 90000, 'Preorder');
...
(2, 'Made Doni', 'doni123', 'Jalan Indah ', 13302, 1104, 1221, 'uploaduser/06062018101241back4.jpg', 'doni@gmail.com', '123456', '123456', '2018-06-07', '081675465', 'male'),
(3, 'Ledy Cahyani', 'ledycahyani', 'Jalan bangli ', 13063, 1102, 1207, 'uploaduser/06062018072122back3.jpg', 'ledy@gmail.com', 'ledy123', 'ledy123', '2018-05-30', '875433345', 'female'),
(4, 'Aditya Dewantara', 'aditya123', 'Jalan sini ', 13084, 1102, 1208, 'uploaduser/06062018072247back7.png', 'aditya@gmail.com', '123456', '123456', '2018-06-21', '0644646464', 'male'),
(5, 'bayudw wibawa', 'bayudarma22', 'Jalan Sana ', 13020, 1101, 1202, 'uploaduser/06062018072411back5.jpg', 'bayudw@gmail.com', '123456', '123456', '2018-06-16', '0864543455', 'male'),
(6, 'Grenceng Winata', 'Masadigrenceng', 'Jalan Nanas ', 13122, 1102, 1209, 'uploaduser/06062018072523ig.png', 'grenceng@gmail.com', '123456', '123456', '2018-06-15', '087654321', 'male');
...
--
ALTER TABLE `fot_event`
  MODIFY `foto_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `fot_sar`
--
ALTER TABLE `fot_sar`
  MODIFY `fotsar_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `peserta`
  MODIFY `peserta_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `sarana`
  MODIFY `sarana_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `order_product`
  ADD CONSTRAINT `order_product_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `order_product_ibfk_3` FOREIGN KEY (`id_sarana`) REFERENCES `sarana` (`sarana_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `peserta`
--
ALTER TABLE `peserta`
  ADD CONSTRAINT `peserta_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`) ON DELETE CASCADE ON UPDATE CASCADE;
