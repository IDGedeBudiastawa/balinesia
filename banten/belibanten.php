            ...
            <div id="isi1" style="width: 90%; margin-left: 5%;">
                ...
                <div class="banten" style="display: flex;">
                    <div class="gam" style="flex: 2;">
                        <img style="width: 500px; height: 500px;" src="<?php echo $rowba['url_sarana'] ?>">
                    ...
                    <div class="form" style="flex: 2">
                        ...
                        <form method="post" action="b_banten.php" require autocomplete="off">
                            <input type="hidden" name="bid" value="<?php echo $rowba['sarana_id'] ?>">
                            <input type="hidden" name="uid" value="<?php echo $uid ?>">
                            <input type="hidden" name="harga" value="<?php echo $rowba['sar_price'] ?>">
                            <div class="form-group">
                                <input type="number" id="jumlah" class="form-control" name="jumlah" placeholder="Jumlah Pesanan" min="1" max="<?php echo $rowba['stock_sar'] ?>" required autocomplete="off">
                            </div>
                            <div id="pilihan" style="display: flex;">
                                <div id="tombol" style="flex: 2;">
                                    <button type="submit" style="width: 150px;" class="btn btn-info" id="tombol">Beli</button>
                                </div>
