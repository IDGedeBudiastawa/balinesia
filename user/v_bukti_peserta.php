<?php 
    ...
    $get_peserta = "SELECT * FROM peserta WHERE peserta_id = '$data_id'";
...
<body>
    <div id="wrapper">
        ...
        <div id="body">
            <div id="isi">
                <br><h1 style="text-align: center; color: #487eb0;">Bukti Pembayaran Peserta</h1><br><br>
                    ...
                    <div id="preview-image">
                        <img src="<?php echo $row2['peserta_path'] ?>">
                        <!-- <img id="uploadPreview" style="width: 150px; height: 150px;"/><br> -->
                    </div>

                    <div id="pilihan" style="margin-top: 40px; display: flex;">
                        <div id="tombol" style="flex: 2;">
                            <button type="submit" style="" class="btn btn-info"><a href="peserta_valid.php" style="text-decoration: none; color: white;">Kembali Untuk Melakukan Validasi</a></button>
                        </div>
