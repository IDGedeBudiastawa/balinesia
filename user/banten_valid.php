        ...
        <div style="margin-top:100px; position: absolute; width: 100%" class="tampil">
          <div id="v_banten">
              <div class="pembatas" style="width: 70%; height: 50px; background-color: #dcdde1; border-radius: 7px">
                <h1 style="text-align: center; color: #222f3e;">DAFTAR BOOKING BANTEN</h1>
              </div><br>
              <table class="table table-striped" style="width: 70%;">
                ...
                <?php 
                  ...
                  $queba = "SELECT order_product.price_product, order_product.order_id, sarana.sar_nama, order_product.price_total, user.full_name, user.address FROM order_product, user JOIN sarana WHERE order_product.id_sarana = sarana.sarana_id AND order_product.user_id=user.user_id AND sarana.user_id = '$id' AND order_product.order_status = 0";
                  ...
                  if ($total > 0) {
                    ...
                    while ($rowba = mysqli_fetch_array($result)) {
                      echo "<tr border='1'>";
                      echo "<td>" .$x. "</td><td>" .$rowba["full_name"]. "</td><td>" . $rowba["address"]. "</td><td>Rp. " . $rowba["price_product"]. "</td><td> Rp. " . $rowba["price_total"]."</td>";
                      echo "<td><a href='v_bukti_banten.php?data_id=".$rowba['order_id']."' class='btn btn-warning' id='custId' data-toggle='modal'>Lihat Bukti</a></td>";
                      echo "<td><a href='b_valid.php?data_id=".$rowba['order_id']."' class='btn btn-info' id='custId' data-toggle='modal'>Validasi</a></td>";
                      echo "</tr>";
