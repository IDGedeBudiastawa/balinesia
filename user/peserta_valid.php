        ...
        <div style="margin-top:100px; position: absolute; width: 100%" class="tampil">
          <div id="v_banten">
              <div class="pembatas" style="width: 70%; height: 50px; background-color: #dcdde1; border-radius: 7px">
                <h1 style="text-align: center; color: #222f3e;">PENDAFTAR BOOKING PESERTA UPACARA</h1>
              </div><br>
              <table class="table table-striped" style="width: 70%;">
                ...
                <?php 
                  ...
                  $queba = "SELECT peserta.peserta_id, peserta.event_id, peserta.fullname, peserta.alamat, peserta.phone, peserta.lahir, peserta.ktp, peserta.email, event.event_nama FROM peserta, event WHERE peserta.status = '0' AND event.event_id = peserta.event_id AND event.event_id = peserta.event_id AND event.user_id = '$id'";
                  ...
                  if ($total > 0) {
                    ...
                    while ($rowba = mysqli_fetch_array($result)) {
                      ...
                      echo "<td><a href='v_bukti_peserta.php?data_id=".$rowba['peserta_id']."' class='btn btn-warning' id='custId' data-toggle='modal'>Lihat Bukti</a></td>";
                      echo "<td><a href='p_valid.php?data_id=".$rowba['peserta_id']."' class='btn btn-info' id='custId' data-toggle='modal'>Validasi</a></td>";
                      echo "</tr>";
