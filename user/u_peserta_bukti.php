    ...
    <div id="wrapper">
        ...
        <div id="body">
            <div id="isi">
                ...
                <form method="POST" action="up_pe.php" enctype="multipart/form-data">
                    <input type="hidden" id="pes_id" class="form-control" name="pes_id" value="<?php echo $data_id; ?>" required autocomplete="off">                    
